...
export const ValueProp: React.FC = () => {
  return (
    <section id="value-prop" className="py-24 lg:py-32 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {VALUE_PROPS.map((item, idx) => (
            <FadeIn key={item.id} delay={idx * 100}>
              <div className="flex flex-col items-start group p-8 rounded-2xl border border-transparent hover:border-slate-100 hover:bg-neutral/50 transition-all duration-300">
