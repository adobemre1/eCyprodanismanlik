      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-full">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <button
            ...
            className="text-xs font-bold text-slate-500 hover:text-primary transition-colors flex items-center gap-1.5 px-3 py-2 rounded-lg hover:bg-slate-50"
          ...
          <a
            ...
            className="text-slate-400 hover:text-[#25D366] transition-colors p-2 rounded-lg hover:bg-slate-50 flex items-center justify-center"
            aria-label="WhatsApp"
          >
            <Phone size={20} />
          </a>
          ...
          <a
            ...
            className="px-6 py-2 bg-primary text-white text-xs font-bold uppercase tracking-widest rounded-full hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary flex items-center"
          >
