        ...
        <div className="mb-24 text-center md:text-left">
          <FadeIn>
            ...
            <h2 id="services-heading" className="text-h2-d font-serif font-bold text-primary max-w-3xl">
              {SERVICES_COPY.titleLine1[lang]}<br />
              {SERVICES_COPY.titleLine2[lang]}
            </h2>
          </FadeIn>
        </div>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
                   <div className="flex-1">
                     <div className="flex items-center gap-4 mb-4">
                       <span className="w-8 h-1 bg-secondary flex-shrink-0"></span>
                       <h3 id={`${category.id}-title`} className="text-3xl md:text-4xl font-serif font-bold text-primary">
                         {category.title[lang]}
                       </h3>
                     </div>
                   ...
                   <div className="mt-6 md:mt-0 hidden md:block flex-shrink-0">
                     <span className="text-xs font-bold text-slate-400 uppercase tracking-widest border border-slate-200 px-4 py-2 rounded-full whitespace-nowrap">
