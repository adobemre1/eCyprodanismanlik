    ...
    <section id="hero" className="relative min-h-screen flex items-center bg-neutral overflow-hidden pt-32 pb-20 lg:pt-0" aria-label="Hero Section">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10">
        <div className="max-w-4xl">
          ...
          <FadeIn delay={200}>
            <h1 className="font-serif text-hero-m md:text-hero-d font-bold text-primary leading-[1.15] mb-8 tracking-tight">
              {HERO_CONTENT.title.line1[lang]}{' '}
